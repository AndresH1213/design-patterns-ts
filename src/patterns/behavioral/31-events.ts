...
// class Personh {
//   public fallsIll: Eventj;
//   constructor(public address) {
//     this.fallsIll = new Eventj();
//   }
...
class Personh {
  private _age: number;
  propertyChanged: Eventj;
  constructor(age: number) {
    this._age = age;
    this.propertyChanged = new Eventj();
  }
...
class RegistrationChecker {
  ...
  constructor(public person: Personh) {
    this.token = person.propertyChanged.subscribe(
      ...
      // is gonna be the reference of the class calling the function (this is Eventj),
